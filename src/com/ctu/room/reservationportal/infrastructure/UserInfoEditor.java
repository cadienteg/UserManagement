        ...
        do {
            ...
            switch (choice) {
                ...
                case 0:
                    ...
                    //calls the createAcccount class
                    CreateAccount.createAccount(scanner);
                    //instantiate the userinfo class
                    UserInfo userInfo = new UserInfo();
                    /**
                     * Retrieves the role at school associated with the user information.
                     *
                     * @return The role at school of the user.
                     */
                    String roleAtschool = userInfo.getRoleAtschool();
                    //call preferRole class
