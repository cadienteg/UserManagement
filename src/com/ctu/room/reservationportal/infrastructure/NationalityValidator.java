...
/**
 * The NationalityValidator class provides methods to validate nationalities.
 */
public class NationalityValidator {

    /**
     * Set of valid nationalities stored as a HashSet.
     */
    private static final Set<String> VALID_NATIONALITIES = new HashSet<>(Arrays.asList(
            // List of valid nationalities
            ...
            "Nauruan", "Nepalese", "New Zealander", "Nicaraguan", "Nigerian", "Nigerien", "North Korean",
    ...
    /**
     * Checks if the provided nationality is valid.
     *
     * @param nationality The nationality to be validated.
     * @return true if the nationality is valid, false otherwise.
     */
